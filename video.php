...
<html>
    <head>
        ...
        <title>ApocalypseWow | Video</title>
    ...
    <body>
        ...
        <div class="banner">
            <div class="background" id="video-banner">
                <img src="/images/banner5.jpg" alt="banner"/>
            </div>
        </div>
        
        <div id="wrapper">
            <p>Many of the films we know and love are in fact riddles with apocalyptic themes.
            Audiences worldwide are becoming more and more attracted to seeing the hero
            escape and survive the end of the world, especially during the last decade. 
            Here are some of our favorite apocalyptic films.</p>
            <h2>Pacific Rim</h2>
